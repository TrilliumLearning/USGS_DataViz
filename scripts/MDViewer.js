                ...
                //
                    ...
                    for (var i = 0; i < placemark.length; i++) {
                        ...
                        if (!color[placemark[i].userProperties[category]]) {
                            gradient.addColorStop(0, color['undefined']);
                        } else {
                    ...
                    success: function (resp) {
                        if (!resp.error) {
                            ...
                            for (var i = 0; i < resp.data.length; i++) {
                                ...
                                placemark[i].userProperties.dep_type = resp.data[i].dep_type;
                                placemark[i].userProperties.commodity = resp.data[i].commodity;
                                placemark[i].userProperties.dep_name = resp.data[i].dep_name;
                                ...
                                var placemarkLayer = new WorldWind.RenderableLayer(resp.data[i].gid);
                                wwd.addLayer(placemarkLayer);
                                wwd.layers[wwd.layers.length - 1].addRenderable(placemark[i]);
