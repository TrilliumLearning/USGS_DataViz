 ...
 *
 *     routes.use(passport.initialize({ userProperty: 'currentUser' }));
 *
 ...
 *
 *     routes.get('/auth/twitter', passport.authenticate('twitter'), function(req, res) {
 *       // request will be redirected to Twitter
 *     });
 *     routes.get('/auth/twitter/callback', passport.authenticate('twitter'), function(req, res) {
 *       res.json(req.user);
 *     });
 *
 ...
 * Examples:
 *
 *     routes.use(connect.cookieParser());
 *     routes.use(connect.session({ secret: 'keyboard cat' }));
 *     routes.use(passport.initialize());
