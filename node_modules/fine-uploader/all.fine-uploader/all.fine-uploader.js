...
(function(global) {
    ...
    qq.UploadButton = function(o) {
        ...
        var self = this, disposeSupport = new qq.DisposeSupport(), options = {
            acceptFiles: null,
            element: null,
            focusClass: "qq-uploadfiles-button-focus",
            folders: false,
            hoverClass: "qq-uploadfiles-button-hover",
    ...
    qq.status = {
        ...
        PAUSED: "paused",
        UPLOADING: "uploading",
        UPLOAD_RETRYING: "retrying uploadfiles",
        UPLOAD_SUCCESSFUL: "uploadfiles successful",
        UPLOAD_FAILED: "uploadfiles failed",
        ...
        qq.basePrivateApi = {
            ...
            _onBeforeManualRetry: function(id) {
                ...
                if (this._preventRetries[id]) {
                    ...
                    this.log("Retrying uploadfiles for '" + fileName + "' (id: " + id + ")...");
                    return true;
                } else {
        ...
        qq.FineUploaderBasic = function(o) {
            ...
            this._options = {
                ...
                messages: {
                    ...
                    noFilesError: "No files to uploadfiles.",
                    ...
                    onLeave: "The files are being uploaded, if you leave now the uploadfiles will be canceled.",
                ...
                classes: {
                    buttonHover: "qq-uploadfiles-button-hover",
                    buttonFocus: "qq-uploadfiles-button-focus"
                },
                chunking: {
                    enabled: false,
                    concurrent: {
    ...
    qq.UploadHandlerController = function(o, namespace) {
        ...
        var controller = this, chunkingPossible = false, concurrentChunkingPossible = false, chunking, preventRetryResponse, log, handler, options = {
            ...
            handleFailure: function(chunkIdx, id, response, xhr) {
                ...
                log("Chunked uploadfiles request failed for " + id + ", chunk " + chunkIdx);
            ...
            sendNext: function(id) {
                ...
                if (chunkIdx == null && inProgressChunks.length === 0) {
                    ...
                    log(qq.format("Sending chunked uploadfiles request for item {}.{}, bytes {}-{} of {}.", id, chunkIdx, chunkData.start + 1, chunkData.end, size));
                    ...
                    if (chunkData.blob.size === 0) {
                        ...
                        handler.uploadChunk(id, chunkIdx, resuming).then(function success(response, xhr) {
                            log("Chunked uploadfiles request succeeded for " + id + ", chunk " + chunkIdx);
                            handler.clearCachedChunk(id, chunkIdx);
            ...
            free: function(id, dontAllowNext) {
                ...
                if (upload.getProxyOrBlob(id) instanceof qq.BlobProxy) {
                    log("Generated blob uploadfiles has ended for " + id + ", disposing generated blob.");
            ...
            send: function(id, name) {
                handler._getFileState(id).loaded = 0;
                log("Sending simple uploadfiles request for " + id);
                handler.uploadFile(id).then(function(response, optXhr) {
                    log("Simple uploadfiles request succeeded for " + id);
                    var responseToReport = upload.normalizeResponse(response, true), size = options.getSize(id);
                    options.onProgress(id, name, size, size);
                    upload.maybeNewUuid(id, responseToReport);
                    upload.cleanup(id, responseToReport, optXhr);
                }, function(response, optXhr) {
                    log("Simple uploadfiles request failed for " + id);
            ...
            maybeSendDeferredFiles: function(id) {
                ...
                if (idsInGroup && idsInGroup.length) {
                    log("Maybe ready to uploadfiles proxy group file " + id);
            ...
            now: function(id) {
                ...
                if (!controller.isValid(id)) {
                    throw new qq.Error(id + " is not a valid file ID to uploadfiles!");
                }
        ...
        qq.extend(this, {
            ...
            reset: function() {
                log("Resetting uploadfiles handler");
        ...
        function registerPostMessageCallback(iframe, callback) {
            ...
            detachLoadEvents[fileId] = qq(iframe).attach("load", function() {
                if (handler.getInput(fileId)) {
                    log("Received iframe load event for CORS uploadfiles request (iframe name " + iframeName + ")");
        ...
        qq.extend(this, {
                ...
                if (isCors) {
                    ...
                    detachLoadEvents[iframe.id] = qq(iframe).attach("load", function() {
                        ...
                        try {
                            ...
                            log("Error when attempting to access iframe during handling of uploadfiles response (" + error.message + ")", "error");
                            responseDescriptor = {
                                success: false
                            };
                        }
            ...
            _parseJsonResponse: function(innerHtmlOrMessage) {
                ...
                try {
                    ...
                    log("Error when attempting to parse iframe uploadfiles response (" + error.message + ")", "error");
                }
                return response;
            }
        });
        ...
        qq.extend(this, {
            ...
            pause: function(id) {
                if (handler.isValid(id)) {
                    log(qq.format("Aborting XHR uploadfiles for {} '{}' due to pause instruction.", id, getName(id)));
    ...
    qq.FormSupport = function(options, startUpload, log) {
        ...
        function validateForm(formEl, nativeSubmit) {
            if (formEl.checkValidity && !formEl.checkValidity()) {
                log("Form did not pass validation checks - will not uploadfiles.", "error");
                nativeSubmit();
            } else {
                return true;
            }
    ...
    qq.traditional.FormUploadHandler = function(options, proxy) {
        ...
        function getIframeContentJson(id, iframe) {
            ...
            try {
                ...
                log("Error when attempting to parse form uploadfiles response (" + error.message + ")", "error");
                response = {
                    success: false
                };
            }
        ...
        this.uploadFile = function(id) {
            ...
            log("Sending uploadfiles request for " + id);
            form.submit();
            qq(form).remove();
            return promise;
        };
    ...
    qq.FineUploader = function(o, namespace) {
        ...
        qq.extend(this._options, {
            ...
            classes: {
                retrying: "qq-uploadfiles-retrying",
                retryable: "qq-uploadfiles-retryable",
                success: "qq-uploadfiles-success",
                fail: "qq-uploadfiles-fail",
                editable: "qq-editable",
                hide: "qq-hide",
                dropActive: "qq-uploadfiles-drop-area-active"
            },
            ...
            deleteFile: {
                forceConfirm: false,
                confirmMessage: "Are you sure you want to trashfolder {filename}?",
    ...
    qq.Templating = function(spec) {
        ...
        var FILE_ID_ATTR = "qq-file-id", FILE_CLASS_PREFIX = "qq-file-id-", THUMBNAIL_MAX_SIZE_ATTR = "qq-max-size", THUMBNAIL_SERVER_SCALE_ATTR = "qq-server-scale", HIDE_DROPZONE_ATTR = "qq-hide-dropzone", DROPZPONE_TEXT_ATTR = "qq-drop-area-text", IN_PROGRESS_CLASS = "qq-in-progress", HIDDEN_FOREVER_CLASS = "qq-hidden-forever", fileBatch = {
            ...
            button: "qq-uploadfiles-button-selector",
            ...
            drop: "qq-uploadfiles-drop-area-selector",
            list: "qq-uploadfiles-list-selector",
            progressBarContainer: "qq-progress-bar-container-selector",
            progressBar: "qq-progress-bar-selector",
            totalProgressBarContainer: "qq-total-progress-bar-container-selector",
            totalProgressBar: "qq-total-progress-bar-selector",
            file: "qq-uploadfiles-file-selector",
            spinner: "qq-uploadfiles-spinner-selector",
            size: "qq-uploadfiles-size-selector",
            cancel: "qq-uploadfiles-cancel-selector",
            pause: "qq-uploadfiles-pause-selector",
            continueButton: "qq-uploadfiles-continue-selector",
            deleteButton: "qq-uploadfiles-trashfolder-selector",
            retry: "qq-uploadfiles-retry-selector",
            statusText: "qq-uploadfiles-status-text-selector",
            editFilenameInput: "qq-edit-filename-selector",
            editNameIcon: "qq-edit-filename-icon-selector",
            dropText: "qq-uploadfiles-drop-area-text-selector",
    ...
    qq.UploadSuccessAjaxRequester = function(o) {
        ...
        function handleSuccessResponse(id, xhrOrXdr, isError) {
            ...
            options.log(qq.format("Received the following response body to an uploadfiles success request for id {}: {}", id, responseJson));
            try {
                ...
                if (isError) {
                    options.log(qq.format("Your server indicated failure in its uploadfiles success request response for id {}!", id), "error");
        ...
        qq.extend(this, {
            sendSuccessRequest: function(id, spec) {
                var promise = new qq.Promise();
                options.log("Submitting uploadfiles success request/notification for " + id);
    ...
    qq.s3.InitiateMultipartAjaxRequester = function(o) {
        ...
        function handleInitiateRequestComplete(id, xhr, isError) {
            ...
            if (uploadId === undefined) {
                if (errorMessage) {
                    options.log(qq.format("Specific problem detected initiating multipart uploadfiles request for {}: '{}'.", id, errorMessage), "error");
                } else {
                    options.log(qq.format("Unexplained error with initiate multipart uploadfiles request for {}.  Status code {}.", id, status), "error");
                }
                promise.failure("Problem initiating uploadfiles request.", xhr);
            } else {
                options.log(qq.format("Initiate multipart uploadfiles request successful for {}.  Upload ID is {}", id, uploadId));
        ...
        qq.extend(this, {
            send: function(id) {
                ...
                getHeaders(id).then(function(headers, endOfUrl) {
                    options.log("Submitting S3 initiate multipart uploadfiles request for " + id);
        ...
        qq.extend(this, {
            send: function(id, uploadId, etagEntries) {
                ...
                getHeaders(id, uploadId, body).then(function(headers, endOfUrl) {
                    options.log("Submitting S3 complete multipart uploadfiles request for " + id);
        ...
        qq.extend(this, {
            send: function(id, uploadId) {
                getHeaders(id, uploadId).then(function(headers, endOfUrl) {
                    options.log("Submitting S3 Abort multipart uploadfiles request for " + id);
                    requester.initTransport(id).withPath(endOfUrl).withHeaders(headers).send();
                });
            }
        });
        ...
        var getName = proxy.getName, log = proxy.log, clockDrift = spec.clockDrift, expectedStatus = 200, onGetBucket = spec.getBucket, onGetHost = spec.getHost, onGetKeyName = spec.getKeyName, filenameParam = spec.filenameParam, paramsStore = spec.paramsStore, endpointStore = spec.endpointStore, aclStore = spec.aclStore, reducedRedundancy = spec.objectProperties.reducedRedundancy, region = spec.objectProperties.region, serverSideEncryption = spec.objectProperties.serverSideEncryption, validation = spec.validation, signature = qq.extend({
            ...
            put: function(id, chunkIdx) {
                ...
                chunked.initHeaders(id, chunkIdx, chunkData.blob).then(function(headers, endOfUrl) {
                    if (xhr._cancelled) {
                        ...
                        promise.failure({
                            error: "Chunk uploadfiles cancelled"
                        });
                    } else {
            ...
            host: {
                ...
                if (isError && upload.response.shouldReset(response.code)) {
                    log("This is an unrecoverable error, we must restart the uploadfiles entirely on the next retry attempt.", "error");
                    response.reset = true;
                }
                return {
                    success: !isError,
                ...
                handler._attachLoadEvent(iframe, function(response) {
                    ...
                    if (response) {
                        if (response.success === false) {
                            log("Amazon likely rejected the uploadfiles request", "error");
                            promise.failure(response);
                        }
                    } else {
                        response = {};
        ...
        qq.extend(qq.azure.FineUploaderBasic.prototype, {
            ...
            _deleteBlob: function(relatedToCancel, id) {
                var self = this, deleteBlobSasUri = {}, blobUriStore = {
                    ...
                    if (relatedToCancel) {
                        self.log("Will cancel uploadfiles, but cannot remove uncommitted parts from Azure due to issue retrieving SAS", "error");
                    ...
                    onDeleteComplete: function(id, xhrOrXdr, isError) {
                        ...
                        if (isError) {
                            if (relatedToCancel) {
                                self.log("Will cancel uploadfiles, but failed to remove uncommitted parts from Azure.", "error");
                            } else {
