...
declare module "fine-uploader/lib/core" {
    ...
    export class FineUploaderBasic {
        ...
        /**
         * Send a trash request to the server for the corresponding file id
         *
         * @param number id : The file's id
         */
        ...
        /**
         * Set custom headers for a trash file request. Pass in a file id to make the headers specific to that file
         *
         * @param any customHeaders : The custom headers to include in the uploadfiles request. Fine Uploader may also send some other required headers
         * @param number id : The file id
         */
        ...
        /**
         * Modify the location where trash requests should be directed. Pass in a file id to change the endpoint for that specific item
         *
         * @param string path : A valid URI where trash requests will be sent
         * @param number | HTMLElement identifier : An integer or HTMLElement corresponding to a file
         */
        setDeleteFileEndpoint(path: string, identifier?: number | HTMLElement): void;

        /**
         * Set the parameters for a trash request. Pass in a file id to make the parameters specific to that file
         *
         * @param any params : The parameters to include in the trash request
         * @param number id : The file id
         */
    ...
    export interface DeleteFileOptions {
        /**
         * Any additional headers to attach to all trash file requests
         *
         * @default `{}`
         */
        customHeaders?: any;
        ...
        enabled?: boolean;
        /**
         * The endpoint to which trash file requests are sent.
         *
         * @default `'/server/uploadfiles'`
         */
        endpoint?: string;
        /**
         * Set the method to use for trash requests.
         *
        ...
        method?: string;
        /**
         * Any additional parameters to attach to trash file requests
         *
         * @default `{}`
         */
        params?: any;
    ...
    export interface CoreEvents {
        ...
        /**
         * Called just before a trash request is sent for the associated item.
         *
         * ###Note:
         * This is not the correct callback to influence the trash request.
         * To do that, use the `onSubmitDelete` callback instead
         */
        onDelete?: OnDelete;
        /**
         * Called just after receiving a response from the server for a trash file request
         */
         ...
         * If a promise is returned, a call to failure is the same as returning `false`.
         *
         * Use this callback to influence the trash request.
         * For example, you can change the custom parameters sent with the underlying trash request using the `setDeleteParams` API method
         */
...
declare module "fine-uploader" {
    ...
    export interface UIDeleteFileOptions extends DeleteFileOptions {
        /**
         * The message displayed in the confirm trash dialog
         *
         * @default `'Are you sure you want to trash {filename}?'`
         */
        confirmMessage?: string;
        /**
         * The status message to appear next to a file that has failed to trash
         *
        ...
        /**
         * If this value is set to `true`, the user will be required to confirm the file trash request via a confirmation dialog
         *
         * @default `false`
         */
