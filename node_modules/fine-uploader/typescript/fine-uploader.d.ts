...
declare module "fine-uploader/lib/core" {
    ...
    export class FineUploaderBasic {
        ...
        /**
         * Attempts to continue a paused uploadfiles
         *
        ...
        /**
         * Send a trashfolder request to the server for the corresponding file id
         *
         * @param number id : The file's id
         */
         ...
         * @returns HTMLElement : The button container element associated with a file, or `undefined` if the file was not submitted via a Fine Uploader controlled uploadfiles button.
         */
         ...
         *
         * If called inside of a cancel event handler, then this method will return a value that includes the uploadfiles associated with the cancel event handler.
         * This is because the uploadfiles will not be canceled until the event handler returns.
         *
        ...
        /**
         * Returns the number of remaining allowed items that may be submitted for uploadfiles based on `validation.itemLimit`.
         */
         ...
         *
         * @param UploadFilter filter : An object which indicates which keys and values must be present in an uploadfiles to be returned
        ...
        /**
         * Attempts to pause an in-progress uploadfiles
         *
         * @param number id : The file id
        ...
        /**
         * Attempt to uploadfiles a specific item again
         *
         * @param number id : The file id
         */
        ...
        /**
         * Set custom headers for an uploadfiles request. Pass in a file id to make the headers specific to that file
         *
         * @param any customHeaders : The custom headers to include in the uploadfiles request. Fine Uploader may also send some other required headers
         * @param number id : The file id
         */
        setCustomHeaders(customHeaders: any, id?: number): void;

        /**
         * Modify the location where uploadfiles requests should be directed. Pass in a file id to change the endpoint for that specific item
         *
         * @param string path : A valid URI where uploadfiles requests will be sent
        ...
        /**
         * Set custom headers for a trashfolder file request. Pass in a file id to make the headers specific to that file
         *
         * @param any customHeaders : The custom headers to include in the uploadfiles request. Fine Uploader may also send some other required headers
         * @param number id : The file id
         */
        ...
        /**
         * Modify the location where trashfolder requests should be directed. Pass in a file id to change the endpoint for that specific item
         *
         * @param string path : A valid URI where trashfolder requests will be sent
         * @param number | HTMLElement identifier : An integer or HTMLElement corresponding to a file
         */
        setDeleteFileEndpoint(path: string, identifier?: number | HTMLElement): void;

        /**
         * Set the parameters for a trashfolder request. Pass in a file id to make the parameters specific to that file
         *
         * @param any params : The parameters to include in the trashfolder request
         * @param number id : The file id
         */
        ...
        /**
         * Set the parameters for an uploadfiles request. Pass in a file id to make the parameters specific to that file
         *
         * @param any params : The parameters to include in the uploadfiles request
         * @param number id : The file id
         */
        ...
        /**
         * Begin uploading all queued items. Throws a `NoFilesError` if there are no items to uploadfiles
         */
    ...
    export interface CoreOptions {
        /**
         * Set to false if you want to be able to uploadfiles queued items later by calling the `uploadStoredFiles()` method
         *
         * @default `true`
         */
        autoUpload?: boolean;
    ...
    export interface DeleteFileOptions {
        /**
         * Any additional headers to attach to all trashfolder file requests
         *
         * @default `{}`
         */
        customHeaders?: any;
        ...
        enabled?: boolean;
        /**
         * The endpoint to which trashfolder file requests are sent.
         *
         * @default `'/server/uploadfiles'`
         */
        endpoint?: string;
        /**
         * Set the method to use for trashfolder requests.
         *
        ...
        method?: string;
        /**
         * Any additional parameters to attach to trashfolder file requests
         *
         * @default `{}`
         */
        params?: any;
    ...
    export interface ExtraButtonsOptions {
        /**
         * The container element for the uploadfiles button
         *
         * @default `undefined`
         */
        element: HTMLElement;
    ...
    export interface FormOptions {
         ...
         *
         * By default, Fine Uploader will intercept submit attempts and instead uploadfiles all submitted files, including data from your form in each uploadfiles request
         *
         * @default `true`
         */
    ...
    export interface Messages {
         ...
         *
         * @default `'No files to uploadfiles.'`
         */
        noFilesError?: string;
        /**
         * Text displayed to the user when they attempt to leave the page while uploads are still in progress
         *
         * @default `'The files are being uploaded, if you leave now the uploadfiles will be canceled.'`
         */
        onLeave?: string;
        /**
    ...
    export interface RetryOptions {
        ...
        enableAuto?: boolean;
        /**
         * The maximum number of times to attempt to retry a failed uploadfiles
         *
         * @default `3`
         */
    ...
    export interface RequestOptions {
        /**
         * Additional headers sent along with each uploadfiles request
         */
        customHeaders?: any;
        /**
         * The endpoint to send uploadfiles requests to
         *
         * @default `'/server/uploadfiles'`
         */
        endpoint?: string;
         ...
         *
         * For non-multipart-encoded uploadfiles requests, this will be included as a parameter in the query string of the URI with a value equal to the file name
         *
         * @default `'qqfile'`
         */
        inputName?: string;
        ...
        method?: string;
        /**
         * The parameters that shall be sent with each uploadfiles request
         */
        params?: any;
        /**
    ...
    export interface TextOptions {
        ...
        /**
         * The value for the `title` attribute attached to the `<input type="file">` maintained by Fine Uploader for each uploadfiles button.
         *
    ...
    export interface WorkArounds {
         ...
         *
         * This only applies to iOS8 Chrome and iOS8 UIWebView, and is put in place to work around an issue that causes the browser to crash when a file input element does not contain a `multiple` attribute inside of a `UIWebView` container created by an iOS8 routes compiled with and iOS7 SDK
         *
         * @default `false`
         */
    ...
    export interface CoreEvents {
        ...
        /**
         * Called when the item has been canceled. Return `false` to prevent the uploadfiles from being canceled.
         *
         ...
         *
         * Since there is no way to 'pause' the uploadfiles in progress while waiting for the promise to be fullfilled the uploadfiles may actually complete until the promise has actually be fullfilled
         */
        onCancel?: OnCancel;
        /**
         * Called when the item has finished uploading.
         *
         * The `responseJSON` will contain the raw response from the server including the 'success' property which indicates whether the uploadfiles succeeded.
         */
        ...
        /**
         * Called just before a trashfolder request is sent for the associated item.
         *
         * ###Note:
         * This is not the correct callback to influence the trashfolder request.
         * To do that, use the `onSubmitDelete` callback instead
         */
        onDelete?: OnDelete;
        /**
         * Called just after receiving a response from the server for a trashfolder file request
         */
        ...
        /**
         * Called when a pasted image has been received (before uploadfiles).
         *
        ...
        /**
         * Called during the uploadfiles, as it progresses, but only for the AJAX uploader.
         *
        ...
        /**
         * Called just before an uploadfiles is resumed.
         *
         ...
         * If a promise is returned, a call to failure is the same as returning `false`.
         *
         * Use this callback to influence the trashfolder request.
         * For example, you can change the custom parameters sent with the underlying trashfolder request using the `setDeleteParams` API method
         */
        onSubmitDelete?: OnSubmitDelete;
        /**
         * Called when the item has been successfully submitted to the uploader.
         *
         * The file will uploadfiles immediately if there is:
...
declare module "fine-uploader" {
    ...
    export interface UIOptions extends CoreOptions {
         ...
         * When false this will prevent the user from simultaneously selecting or dropping more than one item.
         *
         * Dropping or selecting another item will clear the uploadfiles list. If another is already uploading, it will be canceled.
         *
    ...
    export interface UIDeleteFileOptions extends DeleteFileOptions {
        /**
         * The message displayed in the confirm trashfolder dialog
         *
         * @default `'Are you sure you want to trashfolder {filename}?'`
         */
        confirmMessage?: string;
        /**
         * The status message to appear next to a file that has failed to trashfolder
         *
        ...
        /**
         * If this value is set to `true`, the user will be required to confirm the file trashfolder request via a confirmation dialog
         *
         * @default `false`
         */
    ...
    export interface UIThumbnailsPlaceholderOptions {
         ...
         *
         * This is useful if you expect to return thumbnail URLs in your uploadfiles responses for files types that cannot be previewed.
...
declare module "fine-uploader/lib/azure" {
    ...
    export namespace azure {
        ...
        export class FineUploader extends FineUploaderCore {
            ...
            /**
             * Modify the container URL where uploadfiles requests should be directed.
             *
            ...
            /**
             * Set additional parameters for the uploadfiles success request.
             * ###Note:
             * Fine Uploader will still send the `container URL`, `blob name`, `filename`, and `UUID` as well
             *
             * @param object newParams : The additional parameters set for the uploadfiles request
             * @param number id : A file id to apply these uploadfiles success parameters to
             */
        ...
        export interface AzureRequestOptions extends RequestOptions {
            ...
            containerUrl?: string;
            /**
             * Parameters passed along with each uploadfiles request.
             *
             * @default `{}`
             */
            params?: any;
        ...
        export interface AzureUploadSuccessOptions {
            ...
            method?: string;
            /**
             * Any additional parameters to attach to uploadfiles success file requests.
             *
             * ###Note:
...
declare module "fine-uploader/lib/s3" {
    ...
    export namespace s3 {
        ...
        export class FineUploader extends FineUploaderCore {
             ...
             *
             * @param any newAcl : Canned ACL value to be sent with the uploadfiles request. Used by S3
            ...
            /**
             * Modify the endpoint URL where uploadfiles requests should be directed.
             *
             * The endpoint for a specific file or blob can be changed by passing in an optional `id` parameter.
             * An `id` will always be a number and refers to a single file.
             *
